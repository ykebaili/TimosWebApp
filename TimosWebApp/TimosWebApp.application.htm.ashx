...
<head>
    ...
    <meta name="apple-mobile-web-app-title" content="TimosWebApp">
	...
	<link rel="icon" type="image/png" sizes="32x32" href="~/Icons/timos-32.png">
    <link rel="icon" type="image/png" sizes="48x48" href="~/Icons/timos-48.png">
    <link rel="icon" type="image/png" sizes="128x128" href="~/Icons/timos-128.png">
    <link rel="icon" type="image/png" sizes="144x144" href="~/Icons/timos-144.png">

    <!-----------------------------------------------------------------------------
    <link rel="icon" type="image/png" sizes="152x152" href="~/Icons/timos-152.png">
    <link rel="icon" type="image/png" sizes="192x192" href="~/Icons/timos-192.png">
    <link rel="icon" type="image/png" sizes="256x256" href="~/Icons/timos-256.png">
    <link rel="icon" type="image/png" sizes="512x512" href="~/Icons/timos-512.png"> 
    ------------------------------------------------------------------------------>

    <!-- iPhone(first generation or 2G), iPhone 3G, iPhone 3GS -->
    <link rel="apple-touch-icon" sizes="57x57" href="~/Icons/57ios.png">
    <!-- iPad and iPad mini @1x -->
    <link rel="apple-touch-icon" sizes="76x76" href="~/Icons/76ios.png">
    <!-- iPhone 4, iPhone 4s, iPhone 5, iPhone 5c, iPhone 5s, iPhone 6, iPhone 6s, iPhone 7, iPhone 7s, iPhone8 -->
    <link rel="apple-touch-icon" sizes="120x120" href="~/Icons/120ios.png">
    <!-- iPad and iPad mini @2x -->
    <link rel="apple-touch-icon" sizes="152x152" href="~/Icons/152ios.png">
    <!-- iPad Pro -->
    <link rel="apple-touch-icon" sizes="167x167" href="~/Icons/167ios.png">
    <!-- iPhone X, iPhone 8 Plus, iPhone 7 Plus, iPhone 6s Plus, iPhone 6 Plus -->
    <link rel="apple-touch-icon" sizes="180x180" href="~/Icons/180ios.png">

    <meta name="msapplication-TileImage" sizes="144x144" href="~/Icons/timos-144.png">
    ...
    <link rel='stylesheet' type='text/css' href='~Toastr/build/toastr.min.css'/>
